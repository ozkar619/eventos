...
<?php
    ...
    $obj->set_rule(array(
        ...
        'upload'    =>  array('http://localhost/zebra/zebra/classes/Zebra_Form/examples/tmp', ZEBRA_FORM_UPLOAD_RANDOM_NAMES, 1, 'error', 'Could not upload file!<br>Check that the "tmp" folder exists inside the "examples" folder and that it is writable'),
